 ...
 */ (function (e) {
  ...
  function r(P) {
    ...
    if (j !== _) {
      P[0] = j;
      e: for (var q = 0, te = P.length, kr = te >>> 1; q < kr; ) {
        var _t = 2 * (q + 1) - 1,
          ol = P[_t],
          Nt = _t + 1,
          Ar = P[Nt];
        if (0 > o(ol, j))
          Nt < te && 0 > o(Ar, ol)
            ? ((P[q] = Ar), (P[Nt] = j), (q = Nt))
            : ((P[q] = ol), (P[_t] = j), (q = _t));
        else if (Nt < te && 0 > o(Ar, j)) (P[q] = Ar), (P[Nt] = j), (q = Nt);
        else break e;
      }
    }
    return _;
...
function kp(e, t) {
  if (Xt)
    return e === "compositionend" || (!Ji && lc(e, t))
      ? ((e = rc()), (Jr = Xi = dt = null), (Xt = !1), e)
      : null;
  switch (e) {
    case "paste":
      return null;
...
function oa() {
  Fn && (Fn.detachEvent("onpropertychange", sc), (Jn = Fn = null));
}
function sc(e) {
  if (e.propertyName === "value" && zo(Jn)) {
    var t = [];
    uc(t, Jn, e, Vi(e)), Ws(Cp, t);
  }
}
function Pp(e, t, n) {
  e === "focusin"
    ? (oa(), (Fn = t), (Jn = n), Fn.attachEvent("onpropertychange", sc))
    : e === "focusout" && oa();
}
function Tp(e) {
...
var pc = Io("animationend"),
  mc = Io("animationiteration"),
  hc = Io("animationstart"),
  vc = Io("transitionend"),
  gc = new Map(),
  aa =
...
var Mn =
  ...
  zp = new Set("cancel close invalid load scroll toggle".split(" ").concat(Mn));
function sa(e, t, n) {
  ...
  if (!e[Mr]) {
    (e[Mr] = !0),
      Ps.forEach(function (n) {
        n !== "selectionchange" && (zp.has(n) || wl(n, !1, e), wl(n, !0, e));
      });
...
function kc(e, t, n) {
  (Te[_e++] = Ze), (Te[_e++] = qe), (Te[_e++] = Ft), (Ft = e);
  var r = Ze;
  e = qe;
  var o = 32 - De(r) - 1;
  (r &= ~(1 << o)), (n += 1);
  ...
  switch (e.tag) {
    ...
    case 13:
      return (
        ...
        t !== null
          ? ((n = Ft !== null ? { id: Ze, overflow: qe } : null),
            (e.memoizedState = {
              dehydrated: t,
              treeContext: n,
...
function Nc(e) {
  ...
  function S(f, c, d, g) {
    for (
      var A = null, E = null, C = c, T = (c = 0), z = null;
      C !== null && T < d.length;
      T++
    ) {
  ...
  function k(f, c, d, g) {
    ...
    for (
      var E = (A = null), C = c, T = (c = 0), z = null, N = d.next();
      C !== null && !N.done;
      T++, N = d.next()
    ) {
      C.index > T ? ((z = C), (C = null)) : (z = C.sibling);
...
function uu(e, t) {
  switch ((I(rr, t), I(nr, e), I(Ge, pr), (e = t.nodeType), e)) {
    case 9:
    case 11:
...
function fu(e, t, n, r, o, l) {
  if (
    ...
    (t.updateQueue = null),
    (t.lanes = 0),
    (eo.current = e === null || e.memoizedState === null ? Zp : qp),
    (e = n(r, o)),
    Un)
  ) {
    l = 0;
...
function Rc(e, t) {
  ...
  if (
    ...
    (r = r.queue),
    pu(Ic.bind(null, n, r, e), [e]),
    r.getSnapshot !== t || l || (ne !== null && ne.memoizedState.tag & 1))
  ) {
    if (
      ((n.flags |= 2048),
      ir(9, zc.bind(null, n, r, o, t), void 0, null),
      re === null)
    )
      throw Error(y(349));
    Bt & 30 || Mc(n, t, o);
...
function Xp(e, t, n) {
  ...
  if (Xc(e)) Zc(t, o);
    ...
    (n = xc(e, t, o, r)),
      n !== null && ((o = de()), He(n, e, r, o), qc(n, t, r));
  }
}
function Xc(e) {
  var t = e.alternate;
...
var xo = {
  ...
  Zp = {
    ...
    useSyncExternalStore: function (e, t, n) {
      ...
      return (
        (o.queue = l),
        Ca(Ic.bind(null, r, l, e), [e]),
        (r.flags |= 2048),
        ir(9, zc.bind(null, r, l, n, t), void 0, null),
        n
      );
    },
    useId: function () {
...
function tm(e, t, n) {
  switch (t.tag) {
    ...
    case 10:
      ...
      I(So, r._currentValue), (r._currentValue = o);
      break;
    case 13:
  ...
  switch ((eu(t), t.tag)) {
    ...
    case 6:
      if (e && t.stateNode != null) af(e, t, e.memoizedProps, r);
        ...
        if (((n = zt(rr.current)), zt(Ge.current), Ir(t))) {
          if (
            ((r = t.stateNode),
            (n = t.memoizedProps),
            (r[Ve] = t),
        ...
        e: for (; u !== null; ) {
          switch (u.tag) {
            case 5:
              ...
              break e;
            case 3:
              (oe = u.stateNode.containerInfo), (ze = !0);
              break e;
            case 4:
              (oe = u.stateNode.containerInfo), (ze = !0);
              break e;
...
function pf(e, t, n) {
  for (var r = (e.mode & 1) !== 0; x !== null; ) {
    ...
    if (o.tag === 22 && r) {
      ...
      o.subtreeFlags & 8772 && l !== null ? ((l.return = o), (x = l)) : Ia(e);
  }
}
function Ia(e) {
  for (; x !== null; ) {
...
function He(e, t, n, r) {
  ...
  cr(e, n, r),
    (!(R & 2) || e !== re) &&
      ...
      Se(e, r),
      n === 1 && R === 0 && !(t.mode & 1) && ((gn = J() + 500), Ho && Pt()));
}
function Se(e, t) {
...
function mf(e, t) {
  ...
  if (r & 30 || r & e.expiredLanes || t) t = No(e, r);
    ...
    R |= 2;
    var l = vf();
    (re !== e || le !== t) && ((Ye = null), (gn = J() + 500), It(e, t));
    do
      try {
        cm();
        break;
  ...
  if (t !== 0) {
    if (
      ...
      throw ((n = ur), It(e, 0), ft(e, r), Se(e, J()), n);
    if (t === 6) ft(e, r);
    else {
      if (
      ...
      switch (((e.finishedWork = o), (e.finishedLanes = r), t)) {
        ...
        case 3:
          if (
            (ft(e, r), (r & 130023424) === r && ((t = yu + 500 - J()), 10 < t))
          ) {
            if (co(e, 0) !== 0) break;
  ...
  return Se(e, J()), e.callbackNode === n ? mf.bind(null, e) : null;
}
function Ni(e, t) {
  var n = Vn;
  return (
...
function Fa(e) {
  ...
  if (n === 1) throw ((n = ur), It(e, 0), ft(e, t), Se(e, J()), n);
...
function dm(e, t, n) {
  ...
  r !== null && r.delete(t),
    ...
    re === e &&
      (le & n) === n &&
      (ee === 4 || (ee === 3 && (le & 130023424) === le && 500 > J() - yu)
        ? It(e, 0)
        : (gu |= n)),
    Se(e, t);
}
  ...
  switch (e.tag) {
    case 3:
      ...
      if (t.current.memoizedState.isDehydrated) {
        ...
        n !== 0 &&
          (Gi(t, n | 1), Se(t, J()), !(R & 6) && ((gn = J() + 500), Pt()));
      }
      break;
    case 13:
      Wt(function () {
...
Bs = wu;
Us = Wt;
var Em = { usingClientEntryPoint: !1, Events: [dr, Jt, Do, Hs, Fs, wu] },
  jn = {
...
const Am = "/assets/icon-react-a266d417.png",
  ...
  Im = "/assets/icon-sql-8b38aa0a.png",
...
function ph(e) {
  return typeof e == "symbol" || (dh(e) && uh.call(e) == Jm);
}
function Ga(e) {
...
var _f = function (t) {
  ...
  Bh = function (t) {
    (t = qo(t)), ju(t), Sr(t.horizontal ? zh(t) : Ih(t), t);
  },
  Uh = function (t, n) {
    (n = qo(n)), ju(n);
    ...
    return (
      (l =
        ((r =
          ...
          o)),
        (o.render = function () {
          return qa.default.createElement("a", o.props, o.props.children);
        }),
        r)),
      Ja(o, l)
    );
        ...
        return (
          ls(o, [
            ...
            },
            {
              ...
              value: function () {
                if (typeof window > "u") return !1;
                zl.unregister(this.props.name);
              },
            },
            {
              key: "registerElems",
              value: function (i) {
                zl.register(i, this.childBindings.domNode);
              },
            },
            {
              key: "render",
...
function zn({ children: e, to: t, heightNavbar: n, style: r, onClick: o }) {
...
function Je({ icon: e, alt: t, width: n }) {
  return m.jsx("img", {
    src: e,
    alt: t,
    ...
    children: m.jsx("ul", {
      ...
      children: e.map((t, n) =>
        m.jsxs(
          ...
          {
            children: [
              m.jsx(Je, { icon: t.image, alt: `icon ${t.name}` }),
              t.name,
            ],
          },
          n
  ...
  return m.jsxs("div", {
    ...
    children: [
      m.jsxs("div", {
        ...
        children: [
          m.jsx(Je, { icon: H.DEFAULT, alt: "icon folder" }),
...
function og() {
  return m.jsx("div", {
    ...
    children: m.jsx("p", {
      children: "Dsigned and Built by Henrique Zanetti - 2023",
    }),
  });
}
...
function Sg() {
  ...
  return m.jsxs("div", {
    ...
    children: [
      m.jsx(Je, { icon: H.CURRICULO, alt: "icon curriculo" }),
...
const Pg = [
  ...
  },
  {
    ...
    technologies: ["React", "Javascript", "GitHub Pages"],
    github: "https://github.com/kzanetty/application",
    deploy: { state: !1, path: "https://kzanetty.github.io/application/#/" },
  },
  {
    title: "Portfolio",
